var margin = {top: 50, right: 20, bottom: 10, left: 400},
...
var svg = d3.select("#figure").append("svg")
  ...
  var interaction = d3.selectAll(".bar")
    .on("click", function(d,i) { alert(d.Annot+"\n" + d[1] + " ID : " + "\n" + d.geneID + " : " + d.geneName);})
    .on("mouseover", function(d) { d3.select(this).attr("fill", "yellow"),d.Annot.attr("fill", "yellow");})
